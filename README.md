...
- `distanceFromHqInBlocks`: Returns the number of blocks from Scuber's
  ...
  ```js
  or a distance over 2000 feet and under 2500 feet.
  Finally, Scuber does not allow any ridefunction distanceFromHqInBlocks(someValue) {
...
- `calculatesFarePrice`: Given the same starting and ending block as the
  ...
  flat fare of $25 fs over 2500 feet — the function returns
